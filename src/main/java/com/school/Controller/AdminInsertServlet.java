...
import com.shcool.DBUtil.adminDBUtil;
...
public class AdminInsertServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
	        ...
	        boolean isTrue = adminDBUtil.insertAdmin(stf_id, stf_hireDate, stf_fname, stf_lname, stf_email, stf_phone, stf_address, stf_nic, stf_dob, stf_salary,stf_password, ad_systemAccess, ad_designation);
			
	        if(isTrue == true) {
	        	request.setAttribute("targetPage", "AdminServlet");
			...
			e.printStackTrace();
			System.out.println("Error occures during servlet connection...");
		}
