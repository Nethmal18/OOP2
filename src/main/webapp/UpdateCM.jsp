...
<head>
    <meta charset="UTF-8">
    <title>Update Curriculum Manager</title>
    ...
    <div class="row align-items-center">
        ...
        <div class="col-lg-6">
            <div class="glass-container">
                <h3 class="text-center mb-4"><i class="bi bi-pencil-square"></i>Update Curriculum Manager</h3>
                <form action="UpdateCMServlet" method="post">
                    ...
                    <div class="mb-3 input-group">
                        ...
                        <textarea name="stf_address" class="form-control" rows="2"><%=address%></textarea>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col input-group">
                            ...
                            <input type="text" name="cm_role" class="form-control" placeholder="Role" value="<%=role%>">
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        <button type="submit" name="action" value="update" class="btn btn-primary px-4">
                            <i class="bi bi-pencil-square"></i>Update Curriculum Manager
                        </button>
